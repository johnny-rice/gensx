...
You can also use the [`@gensx/openai`](../component-reference/openai.mdx) package to work with tools using OpenAI's native function calling capabilities.

### Defining a tool

Define your tool as a function object:
